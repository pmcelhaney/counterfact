...
export class OperationTypeCoder extends TypeCoder {
  ...
  writeCode(script) {
    ...
    return `($: OmitValueWhenNever<{ query: ${queryTypeName}, path: ${pathTypeName}, headers: ${headersTypeName}, cookie: ${cookieTypeName}, body: ${bodyType}, context: ${contextTypeImportName}, response: ${responseType}, x: ${xType}, proxy: ${proxyType}, auth: ${this.authType()}, delay: ${delayType} }>) => MaybePromise<${this.responseTypes(
      script,
